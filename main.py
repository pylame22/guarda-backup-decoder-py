...
def _get_backup() -> str:
    with Path.open("guarda_backup.txt") as file:
        return file.read()
...
class GuardaBackupDecrypt:
    _PASSWORD_SALT = "XB7sHH26Hn&FmPLxnjGccKTfPV(yk"  # noqa: S105
    _PASSWORD_POSTFIX = "(tXntTbJFzh]4EuQVmjzM9GXHCth8"  # noqa: S105
    _BLOCK_SIZE = 16
...
def main() -> None:
    ...
    try:
        ...
        raise BackupDecryptError(message) from None
